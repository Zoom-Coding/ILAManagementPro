...
namespace ILAManagementPro.Bll.WorkScheduleMaintenance
{
    ...
    {
        internal static List<ShiftEntity> GetShifts()
        {
        ...
        internal static List<BerthEntity> GetBerths()
        {
        ...
        internal static List<VesselEntity> GetVessels()
        {
        ...
        internal static List<CompanyEntity> GetCompanies()
        {
        ...
        internal static WorkScheduleHeaderEntity RefreshSchedule(
        ...
        internal static List<absWorkHeaderEntity> GetHeadersBySchedule(
          string scheduleId)
        {
            return new AbsWorkHeaderRepository().GetByScheduleHeaderWithoutDetails(Convert.ToInt32(scheduleId));
        }

        internal static void SaveSchedule(bool add, WorkScheduleHeaderEntity schedule)
        {
        ...
        internal static void SaveHeader(bool add, absWorkHeaderEntity workHeader)
        {
        ...
        internal static void DeleteHeader(absWorkHeaderEntity header)
        {
            new AbsWorkHeaderRepository().Delete(header);
        }

        internal static bool IsCheckedIn(List<absWorkHeaderEntity> list)
        {
            bool flag = false;
            if (list.Count == 0)
                return flag;
        ...
        internal static void DeleteJob(WorkScheduleHeaderEntity _schedule)
        {
            AbsWorkHeaderRepository headerRepository = new AbsWorkHeaderRepository();
